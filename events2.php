...
<header class="navbar navbar-inverse navbar-fixed-top" role="banner">
  ...
  <div class = "container">
  <iframe src="https://www.google.com/calendar/embed?src=purduecac%40gmail.com&ctz=America/New_York" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
  <h1><cms:editable name='event1' type='text'>Bowling for Boobs</cms:editable></h1>
  <p><cms:editable name='event1desc' type='richtext'>yes</cms:editable></p>
  </div>
